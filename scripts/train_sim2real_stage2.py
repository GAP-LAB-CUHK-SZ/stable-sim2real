...
from dataset_stage2 import Sim2RealDataset
import torch
...
def get_argparse():
    ...
    parser.add_argument('--resume_path', default='/data/mutian/sim2real/weights/init-sd21_vae.ckpt')
    parser.add_argument('--data_path', default='/data/mutian/generated_depth/diffusion-sim2real_cadcond_scene_diff')
    parser.add_argument('--exp_name', default='diffusion-sim2real_cadcond_stage2_diff_small_new')
    parser.add_argument('--config_file', default='config/generate_depth_cadcond_stage2.yaml')
